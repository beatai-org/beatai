...
tags:
  - AI Agent
summary: 我第一次玩 LLM（大语言模型）时，让我印象最深的一个主要瓶颈是：它们本质上是静态函数，接收输入、吐出回应。能力已经被权重锁死。能微调或后训练，是的，但实时学习、对新输入做出适应，完全不行。一些批评者拿这一点当作"它其实不是真智能"的证据，因为不像人类智能那样能实时学习与成长，LLM 基本上是冻结在时间中的。我当时没怎么深想，就接受了它们的样子。
cover: ./images/better-ai-without-a-better-model/01.thumb.webp
---
...
![](./images/better-ai-without-a-better-model/01.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/02.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/03.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/04.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/05.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/06.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/07.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/08.webp)
*由 Nano Banana 2 生成*
...
![](./images/better-ai-without-a-better-model/09.webp)
*由 Nano Banana 2 生成*
