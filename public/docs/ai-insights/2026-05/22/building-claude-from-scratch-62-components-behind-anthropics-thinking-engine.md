...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/01.webp)
*Claude 式思考（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/02.webp)
*第一阶段（教模型思考）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/03.webp)
*思考通道（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/04.webp)
*Compute 自适应（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/05.webp)
*基于搜索（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/06.webp)
*对比（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/07.webp)
*第二阶段（推理拓扑）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/08.webp)
*Step-back 抽象（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/09.webp)
*ToT（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/10.webp)
*Master Loop（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/11.webp)
*子 agent 纪律（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/12.webp)
*第三阶段（工具执行）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/13.webp)
*Plan and execute（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/14.webp)
*ReAct 循环（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/15.webp)
*MoA（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/16.webp)
*验证者不对称性（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/17.webp)
*第四阶段（生产级可靠性）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/18.webp)
*Self-Refine（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/19.webp)
*工具（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/20.webp)
*编辑纪律（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/21.webp)
*Cache-Aware（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/22.webp)
*第五阶段（仅前沿才有的范式）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/23.webp)
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/24.webp)
*Compute Optimal（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/25.webp)
*精力旋钮（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/26.webp)
*委派成本（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/27.webp)
*第六阶段（元认知）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/28.webp)
*问题分类（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/29.webp)
*执行轨迹（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/30.webp)
*DAG（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/31.webp)
*回滚与 replan（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/32.webp)
*第七阶段（接地）作者绘图*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/33.webp)
*持久化沙箱（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/34.webp)
*真实环境（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/35.webp)
*记忆系统（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/36.webp)
*MCP 工具（作者绘图）*
...
![](./images/building-claude-from-scratch-62-components-behind-anthropics-thinking-engine/37.webp)
*第八阶段（组合）作者绘图*
