...
- [Agent/Skills/Teams 架构演进过程及技术选型之道（站内高保真辣评版）](/docs/ai-insights/viewpoint/agent-skills-teams-architecture-evolution-hifi-spicy.md) 基本保留原文段落含义和论证顺序，只在关键章节补入工程向辣评点评。
