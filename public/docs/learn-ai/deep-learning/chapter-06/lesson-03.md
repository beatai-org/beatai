...
![0621.png](../imgs/0621.png) 进入之前版本页面后，我们找到我们想要安装的PyTorch版本，比如V2.4.0，我们寻找pip安装命令模块，并选择对应CUDA版本下的安装命令，这里注意，选择的CUDA版本不能大于上边我们确认的硬件驱动支持的最高版本。如果这里支持的CUDA版本都大于你显卡驱动支持的最高CUDA版本，说明你的显卡驱动太旧了，你可以安装最新的显卡驱动。
...
VS Code 是一个开源的集成开发环境。你可以在[这个页面](https://code.visualstudio.com/)下载VS Code。 下载完成并安装后，初次打开VS Code，我们需要做一些配置。

**安装中文语言插件** ![0613.png](../imgs/0613.png)
...
![0616.png](../imgs/0616.png) 首先我们点击VS Code右下角的PyThon环境配置按钮。
...
![0618.png](../imgs/0618.png) 我们在VS Code里切换到资源管理器窗口，选择一个文件夹作为项目路径。

![0619.png](../imgs/0619.png) 然后新建一个Python文件，比如“test.py”。
