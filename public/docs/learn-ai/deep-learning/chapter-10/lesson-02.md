...
![1003.png](../imgs/1003.png) 首先我们来定义输入和参数。
...
可以看到上边图片中有一个明暗分隔的竖线。它的像素灰度值为： ![1011.png](../imgs/1011.png)

这时我们如果手动设置如下一个卷积核C1，它的权重为：

![1012.png](../imgs/1012.png) 那么这个C1对上边图片进行卷积操作的输出的值为150。

如果我们用C1来检测一个纯色3x3方块呢？ 纯色3x3的方块对应的图像和灰度值为： ![1013.png](../imgs/1013.png) 经过计算你可以发现C1输出的值为0。

如果我们用C1来检测一个有着横条纹的3x3方块呢？ 横条纹3x3方块对应的图像和灰度值为： ![1014.png](../imgs/1014.png) 经过计算，可以发现C1输出的值仍然为0。
