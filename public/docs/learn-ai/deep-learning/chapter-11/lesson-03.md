...
在GoogLeNet中最重要的就是Inception模块，堆叠的多个Inception模块构成网络的主要框架。 ![1039.png](../imgs/1039.png) 上图展示了Inception模块的主要思想。
...
所以，Inception模块同样将1×1卷积应用在3×3卷积之前来降低输入的通道数。最终，Inception模块的示意图如下： ![1041.png](../imgs/1041.png)
