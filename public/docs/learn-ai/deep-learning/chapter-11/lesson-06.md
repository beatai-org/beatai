...
我们以ResNet-18为例，它的第二个阶段Conv2，由2个ResidualBlock构成， ![1052.png](../imgs/1052.png)
...
接着我们来看ResNet-18的第三个阶段Conv3，它也有2个个ResidualBlock构成。 ![1053.png](../imgs/1053.png) Conv3与Conv2有以下不同：
...
对于更深的ResNet，比如ResNet-50，ResNet-101，ResNet-152，它们都采用了Bottleneck结构的Residual Block。这样做是为了减少网络的计算量。正是因为采用了Bottleneck结构，ResNet-50的计算量几乎和ResNet-34的计算量相当。这样让训练更深层的卷积神经网络变得可以承受。 我们以ResNet-50的Conv2阶段，我们来分析它的3个Residual Block。 ![1054.png](../imgs/1054.png)
