...
接着对每个Token生成独热编码： ![1209.png](../imgs/1209.png) 然后给每个Token随机初始化一个Embedding，假设Embedding的维度为4，所有Token的Embedding形成一个Embedding矩阵。 ![1210.png](../imgs/1210.png) 这样，我们想取得一个Token的Embedding时，只需要用Token的独热编码乘以Embedding矩阵即可。 ![1211.png](../imgs/1211.png)
