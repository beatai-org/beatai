...
从这一节开始，我们将动手来实现一个可以将英文翻译为中文的模型。这一节我们先来做一些数据准备工作。 具体代码在[translator.py](https://github.com/RethinkFun/DeepLearning/blob/master/chapter14/translator.py)里。
...
我们在[之前章节](../chapter12/词典生成.md)讲过如何利用BPE算法构建NLP模型的词典。这里我们就来实际构建一次。
