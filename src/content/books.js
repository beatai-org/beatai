...
//
// A book is a tree of articles defined by a `_meta.json` file. Books are
// identified by id and rendered through one of two content pipelines:
//
//   contentKind: 'markdown'  – the common case. Each article is a plain .md
//                              file under the book's content directory.
//   contentKind: 'mdx'       – JS + Markdown. Today only Learn Claude Code;
//                              its rendering is delegated to <LearnClaudeCode />.
//
// A book's URL is derived (not stored): see getBookBasePath in ./index.js.
// Collections (which book groups belong to a hub) are declared in ./collections.js.
//
